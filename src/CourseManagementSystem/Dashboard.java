...
public class Dashboard extends JFrame {
	...
	public static void courseData() {
	    // Get the table model associated with the courseTable
	    DefaultTableModel model = (DefaultTableModel) courseTable.getModel();
	    // Clear the existing rows in the table model
	    model.setRowCount(0); // Reset the row count to 0
	    ...
	    try {
	        ...
	        while (rs.next()) {
	            ...
	            // Create an array containing the retrieved data
	            String data[] = {id, course_name, course_seat, course_batch, course_year, course_pass};
	            // Add the data array as a new row in the table model
	            model.addRow(data);
	        }
...
public static void dataStudent() {
    ...
    try {
           ...
           String q = "select * from CourseManagementSystem.student";
...
public static void courseSearchEnter(String course) {
    ...
    try {
           Connection con = DriverManager.getConnection(url, dbUsername, dbPassword);
           Statement stmt = con.createStatement();
           String query = "select * from CourseManagementSystem.Course WHERE Course_Name ='"+enteredText+"'";
           ResultSet rs = stmt.executeQuery(query);   
           while(rs.next()){
        	   String id = rs.getString(1);
        	   String course_name = rs.getString(2);
...
public static void tutorSearchEnter(String tutor) {
    ...
    try {
           Connection con2 = DriverManager.getConnection(url, dbUsername, dbPassword);
           Statement stmt2 = con2.createStatement();
           String query2 = "select * from CourseManagementSystem.teacher where First_Name='"+teacher+"'";
           ResultSet rs2 = stmt2.executeQuery(query2);
           while(rs2.next()){
        	   String id = rs2.getString(1);
        	   String firstName = rs2.getString(2);
...
public static String TotalColumns(String tableName) {
	...
	public Dashboard() {
		...
		dashboardBtn.setIcon(new ImageIcon("C:\\Users\\ACER\\AppData\\Local\\Microsoft\\Windows\\INetCache\\IE\\B673EW3S\\icons8-home-20[1].png"));
		...
		coursesBtn.setBounds(34, 236, 158, 46);
		...
		lblNewLabel.setBounds(10, 71, 226, 79);
		lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 16));
		lblNewLabel.setBackground(new Color(0, 0, 64));
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\ACER\\Desktop\\OOP\\CMS\\src\\CourseManagementSystem\\Icons\\icons8-course-50.png"));
		lblNewLabel_4.setBounds(76, 42, 79, 57);
		...
		btnDeleteCourse.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		searchCourse.setBounds(31, 91, 313, 37);
		...
		JLabel lblCourseInformation = new JLabel("Courses");
		lblCourseInformation.setIcon(new ImageIcon("C:\\Users\\ACER\\Downloads\\icons8-course-assign-20.png"));
		...
		lblNewLabel_3.setBounds(10, 93, 45, 24);
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\ACER\\Downloads\\icons8-search-20.png"));
		...
		btnAddTutors.setFont(new Font("Tahoma", Font.PLAIN, 12));
...
;				ta.setVisible(true);
		...
		JLabel lblTeacherInformation = new JLabel("Tutors");
		lblTeacherInformation.setHorizontalAlignment(SwingConstants.CENTER);
		lblTeacherInformation.setFont(new Font("Arial Black", Font.PLAIN, 24));
		...
		studentAdd.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		JButton btnEditStudent = new JButton("Update Student");
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\ACER\\Downloads\\icons8-search-20.png"));
		lblNewLabel_2.setBounds(10, 96, 45, 13);
		...
		lblSetting.setIcon(new ImageIcon("C:\\Users\\ACER\\Downloads\\icons8-setting-20.png"));
		lblSetting.setFont(new Font("Arial", Font.BOLD, 20));
		...
		lbluser_1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		btnEditProfile.setBackground(new Color(255, 255, 128));
		btnEditProfile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				EditProfilequery cd = new EditProfilequery();
//				String userMail = Login.mail();
		...
		lblSecurityLogin.setFont(new Font("Arial", Font.BOLD, 20));
		...
		passChange.setBackground(new Color(128, 255, 128));
		passChange.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    PWChangequery pc = new PWChangequery();
		...
		lblCmsSupportHotline.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		JLabel lblPhoneNumber = new JLabel("Phone Number: 000000000");
		...
		lblNotifications.setIcon(new ImageIcon("C:\\Users\\ACER\\Downloads\\icons8-notification-24.png"));
		...
		lblAdminDashboard.setForeground(Color.BLACK);
		lblAdminDashboard.setFont(new Font("Dialog", Font.BOLD, 24));
		lblAdminDashboard.setBackground(Color.BLACK);
		lblAdminDashboard.setBounds(255, 22, 808, 49);
